...
║  Dev Kit V1  ║          ║         │  │        ║
║              ║          ║         ▼  ▼        ║
║  VIN ◄───────╫──────────╫─────── 5V           ║  ← ESP32 dapat daya dari sini
║  GND ────────╫──────────╫─────── GND          ║
║              ║          ║                     ║
║  GPIO27 ─────╫──────────╫► IN1                ║
║  GPIO26 ─────╫──────────╫► IN2                ║
...
║  GPIO33 ─────╫──────────╫► IN4                ║
║  GPIO14 ─────╫──────────╫► ENA  (PWM kiri)    ║
║  GPIO12 ─────╫──────────╫► ENB  (PWM kanan)   ║
╚══════════════╝          ╚═══════════════════╝
```

### 🎨 Konvensi Warna Kabel

| Warna | Fungsi |
|---|---|
| 🔴 Merah | VCC / Positif / 5V / 12V |
| ⚫ Hitam | GND / Negatif |
| 🟡 Kuning | Signal / Data (IN1–IN4) |
| 🔵 Biru | PWM (ENA / ENB) |
| 🟢 Hijau | Output ke motor |
...
```
     ✅ BAIK                    ❌ BURUK (Cold Joint)
        ...
        /\                           ___
       /  \                         /   \
      / 🔆 \    ← mengkilap        ( 💀  )    ← kusam/matte
     /______\                       \___/
   ══════════                      ══════

   Kerucut, mengkilap            Bulat, kusam
   Menempel kuat                 Mudah lepas
   Koneksi bagus                 Resistansi tinggi
```
